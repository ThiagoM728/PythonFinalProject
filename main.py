...
def root():
    ...
    return render_template('homepage.html', itemData=itemData, loggedIn=loggedIn, firstName=firstName,
    ...
    if request.method == 'POST':
        ...
        with sqlite3.connect('database.db') as con:
            try:
                ...
                cur.execute('INSERT INTO users (password, email, firstName) VALUES (?, ?, ?)',
